...
const setAdmin = (req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        const rest = yield restaurantModel_1.default.findOne({ _id });
        if ((user === null || user === void 0 ? void 0 : user.Role) === "Owner" || (rest === null || rest === void 0 ? void 0 : rest.Role) === "Owner")
            throw { message: "شما نمیتوانید نقش این کاربر را تغییر دهید" };
        if (!["Admin", "Restaurant", "User"].includes(Role))
            throw { message: "نقش تعیین شده صحیح نمیباشد" };
        yield userModel_1.default.updateOne({ _id }, { Role });
        yield restaurantModel_1.default.updateOne({ _id }, { Role });
...
const setRole = (req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        const user = yield userModel_1.default.findOne({ _id });
        const rest = yield restaurantModel_1.default.findOne({ _id });
        if ((user === null || user === void 0 ? void 0 : user.Role) === "Owner" || (rest === null || rest === void 0 ? void 0 : rest.Role) === "Owner" || (user === null || user === void 0 ? void 0 : user.Role) === "Admin" || (rest === null || rest === void 0 ? void 0 : rest.Role) === "Admin")
            throw { message: "شما نمیتوانید نقش این کاربر را تغییر دهید" };
