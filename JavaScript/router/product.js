...
const checkPermission_1 = __importDefault(require("../Validation/checkPermission"));
...
prodRouter.delete("/delete/:id", checkLogin_1.default, (0, checkPermission_1.default)("admin"), prodController_1.deleteProd);
